...
echo. >> "Notice d'utilisation.txt"
echo pour le tester reouvrit TimeShut.bat et il va prorposer le test  >> "Notice d'utilisation.txt"
echo. >> "Notice d'utilisation.txt"
...
echo.>> "Notice d'utilisation.txt"
echo 5 :: C'est quoi le repertoire de télechargement ?>> "Notice d'utilisation.txt"
echo. >> "Notice d'utilisation.txt"
